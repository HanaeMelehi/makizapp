...
export class ProjectEditorComponent {
    ...
    uploadNewThumbnail(thumbnail: HTMLInputElement) {
        if (thumbnail.files != null) {
            ...
            reader.onload = () => {
                ...
                this.http.put(this.SERVER_PATH + `/admin/projects/resources/${this.resourceSelected?.id}/thumbnail/`, {"name": `thumbnail_${this.resourceSelected?.id}`, "media": thumbnail_file},{responseType: 'text'}).subscribe((res) => {
    ...
    uploadNewVideo(video: HTMLInputElement) {
        this.http.put(this.SERVER_PATH + `/admin/projects/resources/${this.resourceSelected?.id}/video/`, {"name": `video_${this.resourceSelected?.id}`, "media": video.value},{responseType: 'text'}).subscribe((res) => {
    ...
    uploadNewImage(image: HTMLInputElement) {
      if (image.files != null) {
        ...
        reader.onload = () => {
          ...
          this.http.put(this.SERVER_PATH + `/admin/projects/resources/${this.resourceSelected?.id}/image/`, {"name": `image_${this.resourceSelected?.id}`, "media": image_file},{responseType: 'text'}).subscribe((res) => {
