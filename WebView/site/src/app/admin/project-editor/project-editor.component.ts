...
export class ProjectEditorComponent {
    ...
    /**
     *
     * @property bodyEdition : {}
     * @private
     * This variable allows you to encapsulate the changes made for an edition and allows you to modify only the components during saving
     */
    private bodyEdition: {} = {};
    ...
    uploadNewThumbnail(thumbnail: HTMLInputElement) {
        ...
        this.http.post(this.SERVER_PATH + `/admin/projects/ressources/${this.resourceSelected?.id}/thumbnail/`, {'name': `thumbnail_res_${this.resourceSelected?.id}`, 'image': imgBase64}).subscribe(() => {
