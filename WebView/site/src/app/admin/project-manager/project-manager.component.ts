...
export class ProjectManagerComponent {
    ...
    updateApp() {
        ...
        this.http.get<any>(SERVER_PATH + "/public/projects/").pipe(map((value: ProjectList) => {
            return value
        ...
        this.http.get<any>(SERVER_PATH + "/public/storage/").pipe(map((value: StorageInformations) => {
            return value
